...
export function GallerySwipe({ photos }: GallerySwipeProps) {
  ...
  // Fixed uniform duration for all rows — same speed, same visual flow
  const ROW_DURATION = 20;
  ...
  return (
    <section id="section-gallery" className="relative py-20 bg-gradient-to-b from-[#0d0309] via-[#1a0b16] to-[#0d0309] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-1 w-full max-w-lg mx-auto">
        <MarqueeRow photos={row1} direction="left" onSelect={handleSelect} duration={ROW_DURATION} />
        <MarqueeRow photos={row2} direction="right" onSelect={handleSelect} duration={ROW_DURATION} />
        <MarqueeRow photos={row3} direction="left" onSelect={handleSelect} duration={ROW_DURATION} />
        <MarqueeRow photos={row4} direction="right" onSelect={handleSelect} duration={ROW_DURATION} />
      </div>
